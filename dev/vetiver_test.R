...
vetiver_model <- vetiver::vetiver_model(my_model, "my_model")
...
vetiver::vetiver_pin_write(board = board, vetiver_model = vetiver_model)

v <- vetiver::vetiver_pin_read(board, "hannar1/my_model")
